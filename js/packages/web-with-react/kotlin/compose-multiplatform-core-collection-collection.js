(function (root, factory) {
  ...
  var toLong = kotlin_kotlin.$_$.q4;
  var countTrailingZeroBits = kotlin_kotlin.$_$.m5;
  var _ULong___init__impl__c78o9k = kotlin_kotlin.$_$.n1;
  var _ULong___get_data__impl__fggpzb = kotlin_kotlin.$_$.o1;
  var ulongCompare = kotlin_kotlin.$_$.x5;
  ...
  var longArrayOf = kotlin_kotlin.$_$.m4;
  //endregion
  ...
  function initializeStorage($this, initialCapacity) {
    ...
    var newCapacity = tmp;
    $this.mp_1 = newCapacity;
    initializeMetadata($this, newCapacity);
    $this.kp_1 = new Int32Array(newCapacity);
    $this.lp_1 = new Int32Array(newCapacity);
  }
  function initializeMetadata($this, capacity) {
    ...
    var i = capacity >> 3;
    var b = (capacity & 7) << 3;
    data[i] = data[i].a2((new Long(255, 0)).x1(b).w1()).b2(value.x1(b));
    initializeGrowth($this);
  }
  function initializeGrowth($this) {
    $this.tp_1 = loadedCapacity($this.up()) - $this.np_1 | 0;
  }
  function findInsertIndex($this, key) {
    ...
    var probeMask = $this.mp_1;
    var probeOffset = hash1 & probeMask;
    var probeIndex = 0;
    $l$loop_0: while (true) {
      // Inline function 'androidx.collection.group' call
      var metadata = $this.jp_1;
      var offset = probeOffset;
      var i = offset >> 3;
      var b = (offset & 7) << 3;
      var g = metadata[i].z1(b).b2(metadata[i + 1 | 0].x1(64 - b | 0).a2(toLong(b).v1().y1(63)));
      // Inline function 'androidx.collection.match' call
      // Inline function 'kotlin.Long.times' call
      var tmp$ret$4 = (new Long(16843009, 16843009)).s1(toLong(hash2));
      var x = g.c2(tmp$ret$4);
      var m = x.r1(new Long(16843009, 16843009)).a2(x.w1()).a2(new Long(-2139062144, -2139062144));
      $l$loop: while (true) {
        ...
        if ($this.kp_1[index] === key) {
          return index;
        }
        // Inline function 'androidx.collection.next' call
        var this_1 = m;
        m = this_1.a2(this_1.r1(new Long(1, 0)));
      }
      // Inline function 'androidx.collection.maskEmpty' call
      if (!g.a2(g.w1().x1(6)).a2(new Long(-2139062144, -2139062144)).equals(new Long(0, 0))) {
        break $l$loop_0;
      }
    ...
    if ($this.tp_1 === 0) {
      ...
      tmp_0 = !$this.jp_1[offset_0 >> 3].y1((offset_0 & 7) << 3).a2(new Long(255, 0)).equals(new Long(254, 0));
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
    ...
    if ($this.jp_1[offset_1 >> 3].y1((offset_1 & 7) << 3).a2(new Long(255, 0)).equals(new Long(128, 0))) {
      tmp_3 = 1;
    } else {
      tmp_3 = 0;
    }
    tmp_1.tp_1 = tmp_2 - tmp_3 | 0;
    ...
    var i_0 = index_1 >> 3;
    var b_0 = (index_1 & 7) << 3;
    m_0[i_0] = m_0[i_0].a2((new Long(255, 0)).x1(b_0).w1()).b2(value.x1(b_0));
    var c = $this.mp_1;
    var cloneIndex = ((index_1 - 7 | 0) & c) + (7 & c) | 0;
    // Inline function 'androidx.collection.writeRawMetadata' call
    var i_1 = cloneIndex >> 3;
    var b_1 = (cloneIndex & 7) << 3;
    m_0[i_1] = m_0[i_1].a2((new Long(255, 0)).x1(b_1).w1()).b2(value.x1(b_1));
    return ~index_0;
  }
  function findFirstAvailableSlot($this, hash1) {
    ...
    while (true) {
      ...
      var m = g.a2(g.w1().x1(7)).a2(new Long(-2139062144, -2139062144));
      if (!m.equals(new Long(0, 0))) {
        var tmp = probeOffset;
        // Inline function 'androidx.collection.lowestBitSet' call
  ...
  function adjustStorage($this) {
    ...
    if ($this.mp_1 > 8) {
      ...
      var this_2 = _ULong___init__impl__c78o9k(_ULong___get_data__impl__fggpzb(this_1).s1(_ULong___get_data__impl__fggpzb(other)));
      // Inline function 'kotlin.ULong.times' call
      // Inline function 'kotlin.toULong' call
      var this_3 = $this.mp_1;
      var this_4 = _ULong___init__impl__c78o9k(toLong(this_3));
      var other_0 = _ULong___init__impl__c78o9k(new Long(25, 0));
      var other_1 = _ULong___init__impl__c78o9k(_ULong___get_data__impl__fggpzb(this_4).s1(_ULong___get_data__impl__fggpzb(other_0)));
      tmp = ulongCompare(_ULong___get_data__impl__fggpzb(this_2), _ULong___get_data__impl__fggpzb(other_1)) <= 0;
    } else {
      tmp = false;
    }
    if (tmp) {
      resizeStorage($this, nextCapacity($this.mp_1));
    } else {
      resizeStorage($this, nextCapacity($this.mp_1));
    }
  }
  function resizeStorage($this, newCapacity) {
    var previousMetadata = $this.jp_1;
    var previousKeys = $this.kp_1;
    var previousValues = $this.lp_1;
    var previousCapacity = $this.mp_1;
    initializeStorage($this, newCapacity);
    var newKeys = $this.kp_1;
    var newValues = $this.lp_1;
    ...
    if (inductionVariable < previousCapacity)
      do {
        ...
        // Inline function 'androidx.collection.readRawMetadata' call
        if (previousMetadata[i >> 3].y1((i & 7) << 3).a2(new Long(255, 0)).v(new Long(128, 0)) < 0) {
          ...
          var i_0 = index >> 3;
          var b = (index & 7) << 3;
          m[i_0] = m[i_0].a2((new Long(255, 0)).x1(b).w1()).b2(value.x1(b));
          var c = $this.mp_1;
          var cloneIndex = ((index - 7 | 0) & c) + (7 & c) | 0;
          // Inline function 'androidx.collection.writeRawMetadata' call
          var i_1 = cloneIndex >> 3;
          var b_0 = (cloneIndex & 7) << 3;
          m[i_1] = m[i_1].a2((new Long(255, 0)).x1(b_0).w1()).b2(value.x1(b_0));
  ...
  protoOf(MutableIntIntMap).vp = function (key, value) {
    var index = findInsertIndex(this, key);
    if (index < 0)
      index = ~index;
    this.kp_1[index] = key;
    this.lp_1[index] = value;
  };
  function IntIntMap() {
    this.jp_1 = get_EmptyGroup();
    this.kp_1 = get_EmptyIntArray();
    this.lp_1 = get_EmptyIntArray();
    this.mp_1 = 0;
    this.np_1 = 0;
  }
  protoOf(IntIntMap).up = function () {
    return this.mp_1;
  };
  protoOf(IntIntMap).h = function () {
    return this.np_1;
  };
  ...
  protoOf(IntIntMap).toString = function () {
    ...
    var s = StringBuilder_init_$Create$().w6(_Char___init__impl__6a9atx(123));
    var i = 0;
    // Inline function 'androidx.collection.IntIntMap.forEach' call
    var k = this.kp_1;
    var v = this.lp_1;
            ...
            if (inductionVariable_0 < bitCount)
              do {
                ...
                if (slot.a2(new Long(255, 0)).v(new Long(128, 0)) < 0) {
                  ...
                  i = i + 1 | 0;
                  if (i < this.np_1) {
                    s.w6(_Char___init__impl__6a9atx(44)).w6(_Char___init__impl__6a9atx(32));
                  }
                }
                slot = slot.y1(8);
              }
    ...
    return s.w6(_Char___init__impl__6a9atx(125)).toString();
  };
  protoOf(IntIntMap).xp = function (key) {
    // Inline function 'androidx.collection.hash' call
    var hash = imul(key, -862048943);
    var hash_0 = hash ^ hash << 16;
    // Inline function 'androidx.collection.h2' call
  ...
  var EmptyIntArray;
  function IntSet() {
    this.yp_1 = get_EmptyGroup();
    this.zp_1 = get_EmptyIntArray();
    this.aq_1 = 0;
    this.bq_1 = 0;
  }
  protoOf(IntSet).up = function () {
    return this.aq_1;
  };
  protoOf(IntSet).wp = function (element) {
    var tmp$ret$9;
    $l$block: {
  ...
  protoOf(IntSet).cq = function (separator, prefix, postfix, limit, truncated) {
  ...
  protoOf(IntSet).dq = function (separator, prefix, postfix, limit, truncated, $super) {
    separator = separator === VOID ? ', ' : separator;
    prefix = prefix === VOID ? '' : prefix;
    postfix = postfix === VOID ? '' : postfix;
    limit = limit === VOID ? -1 : limit;
    truncated = truncated === VOID ? '...' : truncated;
    return $super === VOID ? this.cq(separator, prefix, postfix, limit, truncated) : $super.cq.call(this, separator, prefix, postfix, limit, truncated);
  };
  ...
  function initializeStorage_0($this, initialCapacity) {
    ...
    $this.zp_1 = new Int32Array(newCapacity);
  }
  ...
  function initializeGrowth_0($this) {
    $this.iq_1 = loadedCapacity($this.up()) - $this.bq_1 | 0;
  }
  ...
  function initializeStorage_1($this, initialCapacity) {
    ...
    var newCapacity = tmp;
    $this.mq_1 = newCapacity;
    initializeMetadata_1($this, newCapacity);
    var tmp_0 = $this;
    // Inline function 'kotlin.arrayOfNulls' call
    tmp_0.kq_1 = fillArrayVal(Array(newCapacity), null);
    $this.lq_1 = new Int32Array(newCapacity);
  }
  ...
  function initializeGrowth_1($this) {
    $this.tq_1 = loadedCapacity($this.up()) - $this.nq_1 | 0;
  }
  function findIndex($this, key) {
    ...
    // Inline function 'androidx.collection.h2' call
    var hash2 = hash_0 & 127;
    var probeMask = $this.mq_1;
    var probeOffset = hash1 & probeMask;
    var probeIndex = 0;
    $l$loop_0: while (true) {
      // Inline function 'androidx.collection.group' call
      var metadata = $this.jq_1;
      var offset = probeOffset;
      var i = offset >> 3;
      var b = (offset & 7) << 3;
      var g = metadata[i].z1(b).b2(metadata[i + 1 | 0].x1(64 - b | 0).a2(toLong(b).v1().y1(63)));
      // Inline function 'androidx.collection.match' call
      // Inline function 'kotlin.Long.times' call
      var tmp$ret$5 = (new Long(16843009, 16843009)).s1(toLong(hash2));
      var x = g.c2(tmp$ret$5);
      var m = x.r1(new Long(16843009, 16843009)).a2(x.w1()).a2(new Long(-2139062144, -2139062144));
      $l$loop: while (true) {
        // Inline function 'androidx.collection.hasNext' call
        if (!!m.equals(new Long(0, 0))) {
    ...
    if ($this.tq_1 === 0) {
      ...
      // Inline function 'androidx.collection.readRawMetadata' call
      var offset_0 = index_0;
      tmp_0 = !$this.jq_1[offset_0 >> 3].y1((offset_0 & 7) << 3).a2(new Long(255, 0)).equals(new Long(254, 0));
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
    ...
    // Inline function 'androidx.collection.readRawMetadata' call
    var offset_1 = index_0;
    if ($this.jq_1[offset_1 >> 3].y1((offset_1 & 7) << 3).a2(new Long(255, 0)).equals(new Long(128, 0))) {
      tmp_3 = 1;
    } else {
      tmp_3 = 0;
    }
    tmp_1.tq_1 = tmp_2 - tmp_3 | 0;
  ...
  function adjustStorage_0($this) {
    ...
    if (tmp) {
      resizeStorage_0($this, nextCapacity($this.mq_1));
    } else {
      resizeStorage_0($this, nextCapacity($this.mq_1));
    }
  }
  function resizeStorage_0($this, newCapacity) {
    var previousMetadata = $this.jq_1;
    var previousKeys = $this.kq_1;
    var previousValues = $this.lq_1;
    var previousCapacity = $this.mq_1;
    initializeStorage_1($this, newCapacity);
    var newKeys = $this.kq_1;
    var newValues = $this.lq_1;
    var inductionVariable = 0;
    if (inductionVariable < previousCapacity)
      do {
        var i = inductionVariable;
  ...
  protoOf(MutableObjectIntMap).uq = function (key, value, default_0) {
    var index = findIndex(this, key);
    var previous = default_0;
    if (index < 0) {
      index = ~index;
    } else {
      previous = this.lq_1[index];
    }
    this.kq_1[index] = key;
    this.lq_1[index] = value;
    return previous;
  };
  protoOf(MutableObjectIntMap).vq = function (index) {
    this.nq_1 = this.nq_1 - 1 | 0;
    // Inline function 'androidx.collection.MutableObjectIntMap.writeMetadata' call
    ...
    var i = index >> 3;
    var b = (index & 7) << 3;
    m[i] = m[i].a2((new Long(255, 0)).x1(b).w1()).b2(value.x1(b));
    var c = this.mq_1;
    var cloneIndex = ((index - 7 | 0) & c) + (7 & c) | 0;
    // Inline function 'androidx.collection.writeRawMetadata' call
    var i_0 = cloneIndex >> 3;
    var b_0 = (cloneIndex & 7) << 3;
    m[i_0] = m[i_0].a2((new Long(255, 0)).x1(b_0).w1()).b2(value.x1(b_0));
    this.kq_1[index] = null;
  };
  function ObjectIntMap() {
    this.jq_1 = get_EmptyGroup();
    this.kq_1 = get_EMPTY_OBJECTS();
    this.lq_1 = get_EmptyIntArray();
    this.mq_1 = 0;
    this.nq_1 = 0;
  }
  protoOf(ObjectIntMap).up = function () {
    return this.mq_1;
  };
  protoOf(ObjectIntMap).h = function () {
    return this.nq_1;
  };
  protoOf(ObjectIntMap).p = function () {
    return this.nq_1 === 0;
  };
  protoOf(ObjectIntMap).e1 = function (key) {
    var index = this.wq(key);
    if (index < 0) {
      throw NoSuchElementException_init_$Create$('There is no key ' + toString_0(key) + ' in the map');
    }
    return this.lq_1[index];
  };
  ...
  protoOf(ObjectIntMap).wq = function (key) {
    // Inline function 'androidx.collection.hash' call
    // Inline function 'kotlin.hashCode' call
    var tmp1_elvis_lhs = key == null ? null : hashCode(key);
    var tmp$ret$0 = tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs;
  ...
  function initializeStorage_2($this, initialCapacity) {
    ...
    var newCapacity = tmp;
    $this.ar_1 = newCapacity;
    initializeMetadata_2($this, newCapacity);
    var tmp_0 = $this;
    // Inline function 'kotlin.arrayOfNulls' call
    tmp_0.yq_1 = fillArrayVal(Array(newCapacity), null);
    var tmp_1 = $this;
    // Inline function 'kotlin.arrayOfNulls' call
    tmp_1.zq_1 = fillArrayVal(Array(newCapacity), null);
  }
  ...
  function initializeGrowth_2($this) {
    $this.hr_1 = loadedCapacity($this.up()) - $this.br_1 | 0;
  }
  function findFirstAvailableSlot_1($this, hash1) {
    var probeMask = $this.ar_1;
    var probeOffset = hash1 & probeMask;
    var probeIndex = 0;
    while (true) {
      // Inline function 'androidx.collection.group' call
  ...
  function adjustStorage_1($this) {
    ...
    if (tmp) {
      resizeStorage_1($this, nextCapacity($this.ar_1));
    } else {
      resizeStorage_1($this, nextCapacity($this.ar_1));
    }
  }
  function resizeStorage_1($this, newCapacity) {
    ...
    var previousKeys = $this.yq_1;
    var previousValues = $this.zq_1;
    var previousCapacity = $this.ar_1;
    initializeStorage_2($this, newCapacity);
    var newKeys = $this.yq_1;
    var newValues = $this.zq_1;
    var inductionVariable = 0;
    if (inductionVariable < previousCapacity)
      do {
        var i = inductionVariable;
  ...
  protoOf(MutableScatterMap).ir = function (key, value) {
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.collection.MutableScatterMap.set.<anonymous>' call
    var index = this.jr(key);
    var index_0 = index < 0 ? ~index : index;
    this.yq_1[index_0] = key;
    this.zq_1[index_0] = value;
  };
  protoOf(MutableScatterMap).t3 = function (key) {
    var tmp$ret$10;
    $l$block: {
    ...
    if (index_0 >= 0) {
      return this.kr(index_0);
    }
    return null;
  };
  protoOf(MutableScatterMap).kr = function (index) {
    this.br_1 = this.br_1 - 1 | 0;
    // Inline function 'androidx.collection.MutableScatterMap.writeMetadata' call
    var value = new Long(254, 0);
    var m = this.xq_1;
    // Inline function 'androidx.collection.writeRawMetadata' call
    ...
    var oldValue = this.zq_1[index];
    this.zq_1[index] = null;
    return (oldValue == null ? true : !(oldValue == null)) ? oldValue : THROW_CCE();
  };
  protoOf(MutableScatterMap).jr = function (key) {
    // Inline function 'androidx.collection.hash' call
    // Inline function 'kotlin.hashCode' call
    var tmp1_elvis_lhs = key == null ? null : hashCode(key);
    var tmp$ret$0 = tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs;
    ...
    if (this.hr_1 === 0) {
      ...
      // Inline function 'androidx.collection.readRawMetadata' call
      var offset_0 = index_0;
      tmp_0 = !this.xq_1[offset_0 >> 3].y1((offset_0 & 7) << 3).a2(new Long(255, 0)).equals(new Long(254, 0));
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
    ...
    // Inline function 'androidx.collection.readRawMetadata' call
    var offset_1 = index_0;
    if (this.xq_1[offset_1 >> 3].y1((offset_1 & 7) << 3).a2(new Long(255, 0)).equals(new Long(128, 0))) {
      tmp_3 = 1;
    } else {
      tmp_3 = 0;
    }
    tmp_1.hr_1 = tmp_2 - tmp_3 | 0;
    // Inline function 'androidx.collection.MutableScatterMap.writeMetadata' call
    var index_1 = index_0;
    var value = toLong(hash2);
    var m_0 = this.xq_1;
  ...
  function ScatterMap() {
    ...
    this.zq_1 = get_EMPTY_OBJECTS();
    this.ar_1 = 0;
    this.br_1 = 0;
  }
  protoOf(ScatterMap).up = function () {
    return this.ar_1;
  };
  protoOf(ScatterMap).h = function () {
    return this.br_1;
  };
  protoOf(ScatterMap).p = function () {
    return this.br_1 === 0;
  };
  protoOf(ScatterMap).e1 = function (key) {
    var tmp$ret$10;
    $l$block: {
      // Inline function 'androidx.collection.ScatterMap.findKeyIndex' call
      // Inline function 'androidx.collection.hash' call
  ...
  protoOf(ScatterMap).c1 = function (key) {
    var tmp$ret$10;
    $l$block: {
      // Inline function 'androidx.collection.ScatterMap.findKeyIndex' call
      // Inline function 'androidx.collection.hash' call
            ...
            if (inductionVariable_0 < bitCount)
              do {
                ...
                if (slot.a2(new Long(255, 0)).v(new Long(128, 0)) < 0) {
                  ...
                  if (value == null) {
                    if (!(o.e1(key) == null) || !o.c1(key)) {
                      return false;
                    }
                  } else if (!equals(value, o.e1(key))) {
                    return false;
                  }
                }
                slot = slot.y1(8);
  ...
  protoOf(ScatterSet).up = function () {
    return this.nr_1;
  };
  protoOf(ScatterSet).h = function () {
    return this.or_1;
  };
    ...
    $l$block: {
      ...
      $l$loop_0: while (true) {
        ...
        $l$loop: while (true) {
          ...
          var this_0 = m;
          var index = (tmp + (countTrailingZeroBits(this_0) >> 3) | 0) & probeMask;
          if (equals(this.mr_1[index], element)) {
            tmp$ret$10 = index;
            break $l$block;
          }
          // Inline function 'androidx.collection.next' call
  ...
  protoOf(ScatterSet).pr = function (separator, prefix, postfix, limit, truncated, transform) {
    // Inline function 'kotlin.text.buildString' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'kotlin.apply' call
    var this_0 = StringBuilder_init_$Create$();
  ...
  protoOf(ScatterSet).qr = function (separator, prefix, postfix, limit, truncated, transform, $super) {
    separator = separator === VOID ? ', ' : separator;
    prefix = prefix === VOID ? '' : prefix;
    postfix = postfix === VOID ? '' : postfix;
    limit = limit === VOID ? -1 : limit;
    ...
    return $super === VOID ? this.pr(separator, prefix, postfix, limit, truncated, transform) : $super.pr.call(this, separator, prefix, postfix, limit, truncated, transform);
  };
  ...
  protoOf(ScatterSet).toString = function () {
    return this.qr(VOID, '[', ']', VOID, VOID, ScatterSet$toString$lambda(this));
  };
  ...
  function initializeGrowth_3($this) {
    $this.vr_1 = loadedCapacity($this.up()) - $this.or_1 | 0;
  }
  function findAbsoluteInsertIndex($this, element) {
    ...
    if ($this.vr_1 === 0) {
      ...
      // Inline function 'androidx.collection.readRawMetadata' call
      var offset_0 = index_0;
      tmp_0 = !$this.lr_1[offset_0 >> 3].y1((offset_0 & 7) << 3).a2(new Long(255, 0)).equals(new Long(254, 0));
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
    ...
    // Inline function 'androidx.collection.readRawMetadata' call
    var offset_1 = index_0;
    if ($this.lr_1[offset_1 >> 3].y1((offset_1 & 7) << 3).a2(new Long(255, 0)).equals(new Long(128, 0))) {
      tmp_3 = 1;
    } else {
      tmp_3 = 0;
    }
  ...
  function adjustStorage_2($this) {
    ...
    if (tmp) {
      resizeStorage_2($this, nextCapacity($this.nr_1));
    } else {
      resizeStorage_2($this, nextCapacity($this.nr_1));
    }
  }
  function resizeStorage_2($this, newCapacity) {
    ...
    var previousElements = $this.mr_1;
    var previousCapacity = $this.nr_1;
    initializeStorage_3($this, newCapacity);
    var newElements = $this.mr_1;
    var inductionVariable = 0;
    if (inductionVariable < previousCapacity)
      do {
        var i = inductionVariable;
  ...
  protoOf(MutableScatterSet).m = function (element) {
    var oldSize = this.h();
    var index = findAbsoluteInsertIndex(this, element);
    this.mr_1[index] = element;
    return !(this.h() === oldSize);
  };
  protoOf(MutableScatterSet).wr = function (element) {
    var index = findAbsoluteInsertIndex(this, element);
    this.mr_1[index] = element;
  };
  protoOf(MutableScatterSet).h1 = function (element) {
    var tmp$ret$10;
    $l$block: {
      // Inline function 'androidx.collection.ScatterSet.findElementIndex' call
      // Inline function 'androidx.collection.hash' call
  ...
  protoOf(MutableScatterSet).xr = function (index) {
    this.or_1 = this.or_1 - 1 | 0;
    // Inline function 'androidx.collection.MutableScatterSet.writeMetadata' call
    var value = new Long(254, 0);
    var m = this.lr_1;
