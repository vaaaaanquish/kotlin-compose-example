(function (root, factory) {
  ...
  var toString = kotlin_kotlin.$_$.v5;
  //endregion
  ...
  protoOf(AtomicRef).fd = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).gd = function () {
  ...
  protoOf(AtomicBoolean).hd = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).gd = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).id = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).gd = function () {
    return this.kotlinx$atomicfu$value;
  };
